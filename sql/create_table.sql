...
(
    ...
    inputDescription  text                               null comment '输入描述',
    outputDescription text                               null comment '输出描述',
    inputSample       text                               null comment '输入样例',
    outputSample      text                               null comment '输出样例',
    hint              text                               null comment '提示',
    judgeConfig       text                               null comment '判题配置',
    judgeCase         text                               null comment '判题样例',
...
(
    ...
    lang              varchar(512)                       null comment '编程语言',
    code              text                               null comment '提交代码',
    status            int      default 0                 null comment '状态(0-待判题，1-判题中，2-成功，3-失败)',
